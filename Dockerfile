...
# Terraform 1.0.0
ADD https://releases.hashicorp.com/terraform/1.0.0/terraform_1.0.0_linux_amd64.zip /usr/local/bin
RUN unzip /usr/local/bin/terraform_1.0.0_linux_amd64.zip -d /usr/local/bin/ && rm /usr/local/bin/terraform_1.0.0_linux_amd64.zip
